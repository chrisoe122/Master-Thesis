...
LSM15<-function(X,XaL,KQ,KA,dt,Q,EX,fm,sigma,lambda,kp){
  ...
  for (j in 1:EX){
    ...
    for (i in 1:(exercisestep-1)){
      ...
      BL[,time-1]<- flm(X=cbind(1,X[,time-1],Y[,time-1],Z[,time-1],Z1[,time-1],Z2[,time-1],Z3[,time-1],Z4[,time-1],Z5[,time-1],Z6[,time],Z7[,time],Z8[,time],Z9[,time],Z10[,time],Z11[,time],Z12[,time]),y=q[exercisestep-i,])
      EQL[,time-1]<- BL[1,time-1]+BL[2,time-1]*X[,time-1]+BL[3,time-1]*Y[,time-1]+BL[4,time-1]*Z[,time-1]+
        ...
        BL[10,time-1]*Z6[,time-1]+BL[11,time-1]*Z7[,time-1]+BL[12,time-1]*Z8[,time-1]+BL[13,time-1]*Z9[,time-1]+BL[14,time-1]*Z10[,time-1]+
        BL[15,time-1]*Z11[,time-1]+BL[16,time-1]*Z12[,time-1]
    ...
    bex[,EX-j+1]<-flm(X=cbind(1,XINN,YINN,ZINN,ZINN1,ZINN2,ZINN3,ZINN4,ZINN5,ZINN6,ZINN7,ZINN8,ZINN9,ZINN10,ZINN11,ZINN12),y=VINN)
    ...
    CASHH<- bex[1,EX-j+1]+bex[2,EX-j+1]*XINN+bex[3,EX-j+1]*YINN+bex[4,EX-j+1]*ZINN+
      ...
      bex[10,EX-j+1]*ZINN6+bex[11,EX-j+1]*ZINN7+bex[12,EX-j+1]*ZINN8+bex[13,EX-j+1]*ZINN9+bex[14,EX-j+1]*ZINN10+
      bex[15,EX-j+1]*ZINN11+bex[16,EX-j+1]*ZINN12#Cashflow for ITM options
    ...
    #EQL
    BL[,time]<-flm(X=cbind(1,X[,time],Y[,time],Z[,time],Z1[,time],Z2[,time],Z3[,time],Z4[,time],Z5[,time],Z6[,time],Z7[,time],Z8[,time],Z9[,time],Z10[,time],Z11[,time],Z12[,time]),y=VEX)
    EQL[,time]<-BL[1,time]+BL[2,time]*X[,time]+BL[3,time]*Y[,time]+BL[4,time]*Z[,time]+
      BL[5,time]*Z1[,time]+BL[6,time]*Z2[,time]+BL[7,time]*Z3[,time]+BL[8,time]*Z4[,time]+BL[9,time]*Z5[,time]+
      BL[10,time]*Z6[,time]+BL[11,time]*Z7[,time]+BL[12,time]*Z8[,time]+BL[13,time]*Z9[,time]+BL[14,time]*Z10[,time]+
      BL[15,time]*Z11[,time]+BL[16,time]*Z12[,time]
    EQLIN <- EQL[IN,time]
    EQLIN[EXX]<- 0
    EQL[IN,time]<-EQLIN
    EQL[EQL[,time]==0,]<-0
  ...
  for (p in 1:Q){
    ...
    for (i in 1:(exercisestep-1)){
      ...
      BL[,time-1]<- flm(X=cbind(1,X[,time-1],Y[,time-1],Z[,time-1],Z1[,time-1],Z2[,time-1],Z3[,time-1],Z4[,time-1],Z5[,time-1],Z6[,time-1],Z7[,time-1],Z8[,time-1],Z9[,time-1],Z10[,time-1],Z11[,time-1],Z12[,time-1]),y=q[exercisestep-i,])
      EQL[,time-1]<- BL[1,time-1]+BL[2,time-1]*X[,time-1]+BL[3,time-1]*Y[,time-1]+BL[4,time-1]*Z[,time-1]+
        BL[5,time-1]*Z1[,time-1]+BL[6,time-1]*Z2[,time-1]+BL[7,time-1]*Z3[,time-1]+BL[8,time-1]*Z4[,time-1]+BL[9,time-1]*Z5[,time-1]+
        BL[10,time-1]*Z6[,time-1]+BL[11,time-1]*Z7[,time-1]+BL[12,time-1]*Z8[,time-1]+BL[13,time-1]*Z9[,time-1]+BL[14,time-1]*Z10[,time-1]+
        BL[15,time-1]*Z11[,time-1]+BL[16,time-1]*Z12[,time-1]
  ...
  for (j in 1:EX){
    ...
    for (i in 1:(exercisestep-1)){
      EAL[,time-1]<- BL[1,time-1]+BL[2,time-1]*XaL[,time-1]+BL[3,time-1]*YaL[,time-1]+BL[4,time-1]*ZaL[,time-1]+
        ...
        BL[10,time-1]*ZaL6[,time-1]+BL[11,time-1]*ZaL7[,time-1]+BL[12,time-1]*ZaL8[,time-1]+BL[13,time-1]*ZaL9[,time-1]+BL[14,time-1]*ZaL10[,time-1]+
        BL[15,time-1]*ZaL11[,time-1]+BL[16,time-1]*ZaL12[,time-1]
      time<-time-1
    }
    ...
    Co<- BL[1,time]+BL[2,time]*XaL[,time]+BL[3,time]*YaL[,time]+BL[4,time]*ZaL[,time]+
      ...
      BL[10,time]*ZaL6[,time]+BL[11,time]*ZaL7[,time]+BL[12,time]*ZaL8[,time]+BL[13,time]*ZaL9[,time]+BL[14,time]*ZaL10[,time]+
      BL[15,time]*ZaL11[,time]+BL[16,time]*ZaL12[,time]
    EAL[,time]<-Co
    EALIN <- EAL[IN,time]
    CASHH<-bex[1,EX-j+1]+bex[2,EX-j+1]*XINN+bex[3,EX-j+1]*YINN+bex[4,EX-j+1]*ZINN+
      bex[5,EX-j+1]*ZINN1+bex[6,EX-j+1]*ZINN2+bex[7,EX-j+1]*ZINN3+bex[8,EX-j+1]*ZINN4+bex[9,EX-j+1]*ZINN5+
